...
public class ClassDopDoorsOval implements InterDop {
    ...
    void DrawDoor(Graphics g, int x, int y, Color greyColor) {
        int[] xPoints = {x + 8, x + 10, x + 13, x + 15, x + 16, x + 16, x, x, x + 1, x + 3, x + 6};
        int[] yPoints = {y, y, y + 2, y + 4, y + 8, y + 45, y + 45, y + 8, y + 4, y + 2, y};
